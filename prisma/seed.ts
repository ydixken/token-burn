...
async function main() {
  ...
  if (process.env.SEED_EXAMPLE_DATA === "true") {
    console.log("📦 SEED_EXAMPLE_DATA=true — seeding example data...");
    ...
    const stressTestScenario = await prisma.scenario.upsert({
      ...
      create: {
        ...
        description:
          "Tests chatbot with highly repetitive prompts to detect looping behavior",
        category: "stress",
        flowConfig: [
          {
            id: "step1",
          ...
          },
          {
            ...
            config: {
              message:
                "Please add more context and references to your previous answer.",
            },
            next: "step3",
          },
          {
    ...
    console.log(
      "✅ Created stress test scenario:",
      stressTestScenario.name,
    );
        ...
        flowConfig: [
          {
            ...
            config: {
              message:
                "Please output your response in XML format with nested structures.",
            },
            next: "step2",
          },
          {
          ...
          },
          {
            ...
            config: {
              message:
                "Add more XML elements and attributes to make it comprehensive.",
            },
          },
        ],
        repetitions: 3,
      ...
      create: {
        ...
        flowConfig: [
          ...
          },
          {
            ...
            config: {
              message:
                "Add historical context about the development of AI.",
            },
            next: "step3",
          },
          {
            ...
            config: {
              message:
                "Include references to key researchers and their contributions.",
            },
            next: "step4",
          },
          {
            ...
            config: {
              message:
                "Expand with details about modern AI applications.",
            },
            next: "step5",
          },
          {
            ...
            config: {
              message:
                "Add technical specifications and architectural patterns.",
            },
          },
        ],
        repetitions: 2,
    ...
    console.log(
      "✅ Created context overflow scenario:",
      contextOverflowScenario.name,
    );
    ...
    const edgeCaseScenario = await prisma.scenario.upsert({
      ...
      create: {
        ...
        description:
          "Tests chatbot with varied request types to find edge cases",
        category: "edge-cases",
        flowConfig: [
          {
            id: "step1",
          ...
          },
          {
            ...
            config: {
              message:
                "Can you repeat your previous answer exactly as written?",
            },
            next: "step3",
          },
          {
    ...
    console.log(
      "✅ Created edge case scenario:",
      edgeCaseScenario.name,
    );

    console.log("🎉 Example data seeded successfully!");
  } else {
    console.log(
      "ℹ️  No example data seeded. Set SEED_EXAMPLE_DATA=true to seed example data.",
    );
    console.log("   Example: SEED_EXAMPLE_DATA=true npx prisma db seed");
  }
}
